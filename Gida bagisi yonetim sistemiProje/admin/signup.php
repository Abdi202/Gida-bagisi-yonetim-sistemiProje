...
<body>
    <div class="container">
        ...
        <!-- <p class="logo" style="">Food <b style="color:#06C167; ">Donate</b></p> -->
             ...
             <div class="password">
                ...
                <?php
                    if($msg==1){
                        ...
                        echo '<p class="error">Kullanıcı Adı ve Parola uyuşmuyor.</p>';
                    }
                    ?> 
             </div>
            <!-- <div class="input-group">
            ...
            <button type="submit" name="sign">Kayıt Ol</button>
            <div class="login-signup" >
                    <span class="text">Zaten bir üye misiniz??
                        <a href="signin.php" class="text login-link">Giriş Yap</a>
                    </span>
                </div>
        </form>
    </div>
