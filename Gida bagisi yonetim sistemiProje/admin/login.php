    ...
    <div class="container">
        <div class="forms">
            ...
            <div class="form login">
                <?php
                if($msg==1){
                    echo '<p ><center style=\"color:#06C167;\">Hesap başarıyla oluşturuldu</center></p>';
                }
                ?>
            <?php
                if($acc==1){
                  echo ' <p ><center style=\"color:crimson;\">Bu Hesap Zaten Mevcut</center></p>';
                }
                ?>
...
<!-- 
                ...
                <div class="login-signup">
                    <span class="text">Üye değil?
                        <a href="#" class="text signup-link">Şimdi kayıt ol</a>
                    </span>
                </div>
            </div>
            ...
            <div class="form signup">
                ...
                <form action=" " method="post">
                    ...
                    <div class="input-field">
                        <input type="text" placeholder="E-postanızı giriniz" name="email" required>
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <div class="input-field">
                        ...
                        <select id="district" name="district" style="padding:10px; padding-left: 20px;">
                          ...
                          <option value="Skarya">Sakarya</option>
