...
<body>
    ...
    <div class="regform">
        ...
        <form action=" " method="post">
            ...
            <p id="heading">Hesabınızı Oluşturun</p>
            
            <div class="input">
                <label class="textlabel" for="name">Kullanıcı Adı</label><br>
             ...
             <label class="textlabel" for="password">Parola</label>
             <div class="password">
             ...
             <div class="radio">
                ...
                <input type="radio" name="gender" id="Bay" value="Bay" required/>
                <label for="Bay" >Bay</label>
                <input type="radio" name="gender" id="Bayan" value="Bayan">
                <label for="Bayan" >Bayan</label>

             </div>
             <div class="btn">
                <button type="submit" name="sign">Devam Et</button>
             </div>
           ...
           <!-- <button type="submit" style="background-color:white ;color: #000; margin-top:5px;  padding: 10px 25px;">
            ...
            <div class="signin-up">
                 <p style="font-size: 20px; text-align: center;">Hesabınız mı var? <a href="signin.php">Giriş Yap</a></p>
             </div>
