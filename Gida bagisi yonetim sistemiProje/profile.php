...
<!--             
            ...
            <br> -->
              ...
              <p style="">Adı : <?php echo"". $_SESSION['name'] ;?> </p><br>
              <p style="">Email : <?php echo"". $_SESSION['email'];?> </p><br>
              <p style="">Cinsiyet : <?php echo"". $_SESSION['gender'] ;?> </p><br>
               <!-- <p style="font-family: 'Times New Roman', Times, serif;">gender  :<?php echo"". $_SESSION['gender'] ;?> </p><br>  -->
              
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: #06C167; color: white;padding: ;padding-left: 10px;padding-right: 10px;">Çıkış Yap</a>
              </div>
              <br>
              <br>
         ...
         <hr>
         <br>
         <p class="heading">Bağışlarınız</p>
   ...
   <div class="table-container">
       ...
       <tbody>
        ...
        $query="select * from gida_bagislari where email='$email'";
