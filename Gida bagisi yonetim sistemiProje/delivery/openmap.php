...
@import url('https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap');
  ...
  <header>
        ...
        <nav class="nav-bar">
            <ul>
                <li><a href="delivery.php">Anasayfa</a></li>
    ...
    <script>
      ...
      function initMap() {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
          ...
          marker.bindPopup("<b>Buradasiniz!</b>").openPopup();
        ...
        // }).addTo(map);
          ...
          // Retrieve the city name using OpenStreetMap API
            ...
            fetch(url)
              ...
              .then(function (data) {
                ...
                cityNameElement.innerHTML = "siz şu anda şu yerdesin " + cityName;
          ...
          fetch(url)
            ...
            .then(data => {
              document.getElementById("address").innerHTML = `Buradasiniz ${data.display_name}`;
            });
        }, function() {
          // Handle errors when retrieving the user's location
          alert("Hata: Coğrafi Konum hizmeti başarisiz oldu.");
        });
      }
    </script>
