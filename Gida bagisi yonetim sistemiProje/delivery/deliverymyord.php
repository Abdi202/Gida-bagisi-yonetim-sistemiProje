...
<head>
    ...
    <title>Siparişimi Teslim Et</title>
...
<header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li><a href="deliverymyord.php"  class="active">Siparişimi Teslim Et</a></li>
...
<!-- <button type="submit" name="food" onclick="">My orders</button>-->
 <a href="delivery.php">Sipariş Al</a>
  <p>Sana atanmış sipariş</p> 
<br>
</div>
