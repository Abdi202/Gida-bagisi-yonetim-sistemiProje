...
if (isset($_POST['sign'])) {
  ...
  $sql = "select * from teslimat_personeli where email='$sanitized_emailid'";
    ...
    <div class="center">
      ...
      <form method="post">
        ...
        if($msg==1){
                        ...
                        echo '<p class="error">Şifre eşleşmiyor</p>';
                    }
                    ?>
                    <br>
        <!-- <div class="pass">Forgot Password?</div> -->
        <input type="submit" value="Giriş Yap" name="sign">
        <div class="signup_link">
        Üye değil misiniz? <a href="deliverysignup.php">Üye Ol</a>
        </div>
      </form>
    </div>
